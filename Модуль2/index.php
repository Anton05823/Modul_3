 ...
 <div id="loginForm" class="form login">
        ...
        <div id="registerForm" class="form register">
            <form action="register.php" method="post">
                <h1>Регистрация</h1>
                <p>
                    <label class="fam">Фамилия</label>
                    <input  name="fam" required type="text"/>
                </p>
                <p>
                    <label class="imya">Имя</label>
                    <input  name="imya" required type="text"/>
                </p>
                <p>
                    <label class="otch">Отчество</label>
                    <input  name="otch" required type="text"/>
                </p>
                <p>
                    <label  >Логин</label>
                    <input name="login" requiredtype="text"/>
                </p>
                <p>
